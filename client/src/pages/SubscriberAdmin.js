...
const SubscriberAdmin = () => {
  ...
  // Define fetchNotificationData function outside useEffect
  const fetchNotificationData = async () => {
    ...
    try {
      ...
      const [statsResponse, templatesResponse, historyResponse] =
        await Promise.all([
          axios.get("/api/subscribers/stats"),
          axios.get("/api/subscribers/templates"),
          axios.get("/api/subscribers/notifications"),
        ]);
  ...
  const handleFileSelect = (e) => {
    ...
    if (file) {
      // In a real application, you would upload this to your server or CDN
    ...
    try {
      ...
      if (response.data.success) {
        ...
        if (saveAsTemplate && templateName) {
          await axios.post("/api/subscribers/templates", {
            name: templateName,
            title: notificationTitle,
            message: customMessage,
            url: notificationUrl,
    ...
    <PageWrapper>
      <Container>
        <Header>
          ...
          <HeaderRight>
            <ExportButton onClick={exportNotificationData}>
              <FaFileDownload />
                ...
                <StatInfo>
                  <StatValue>
                    {subscriberStats.lastSent
                      ? formatDate(subscriberStats.lastSent).split(" at ")[0]
                      : "Never"}
                  </StatValue>
                  <StatLabel>Last Notification</StatLabel>
                  {subscriberStats.lastSent && (
                    <StatTrend>
                      at {formatDate(subscriberStats.lastSent).split(" at ")[1]}
                    </StatTrend>
                  )}
                </StatInfo>
              </StatCard>
                ...
                <NotificationForm onSubmit={handleSendCustomNotification}>
                  <FormRow>
                    ...
                    <FormGroup>
                      ...
                      >
                        ...
                        <option value="announcement">Announcement Icon</option>
                  ...
                  <FormRow>
                    ...
                    <FormGroup>
                      ...
                      <FieldHint>
                        Recommended size: 1200×600px. Large images may not
                  ...
                  <FormRow>
                    <FormGroup>
                      ...
                      />
                      <FieldHint>
                        Leave empty to send immediately. Scheduled notifications
                ...
                {selectedTemplate && (
                  <TemplateAlert>
                    ...
                    <span>
                      ...
                      " template. Changes won't be saved to the template unless
                      you save it as a new template.
                    </span>
              ...
              <ContentSection>
                ...
                {notificationTemplates.length === 0 ? (
                  <EmptyState>
                    ...
                    <p>
                      Save your notifications as templates to quickly send them
                      again in the future. You can create a template by
                      selecting "Save as template" when sending a notification.
                    </p>
                  </EmptyState>
                ) : (
                  <TemplatesGrid>
                        ...
                        <TableRow key={notification.id}>
                          ...
                          <td>
                            {notification.status === "completed" ? (
                              <PerformanceMetrics>
                                <MetricItem>
                                  <span>Sent:</span> {notification.sent}
                                </MetricItem>
                                <MetricItem>
                                  <span>Opened:</span> {notification.opened}
                                </MetricItem>
                                <MetricItem
                                  className={
                                ...
                                >
                                  <span>Rate:</span> {notification.openRate}%
                                </MetricItem>
                              </PerformanceMetrics>
                            ) : (
                              "-"
                  ...
                  <ChartCard>
                    ...
                    <ResponsiveContainer width="100%" height={250}>
                      <PieChart>
                        ...
                        >
                          {demoData.current.platformData.map((entry, index) => (
                            <Cell
                              key={`cell-${index}`}
                ...
                <BestPracticesGrid>
                  <BestPracticeCard>
                    ...
                    <BestPracticeContent>
                      ...
                      <p>
                        Based on your data, the best times to send notifications
                        are between 7-9 AM and 6-8 PM.
                      </p>
                    </BestPracticeContent>
                  </BestPracticeCard>
                  ...
                  <BestPracticeCard>
                    ...
                    <BestPracticeContent>
                      ...
                      <p>
                        Targeted notifications to specific user segments perform
                        68% better than general broadcasts.
                      </p>
                    </BestPracticeContent>
                  </BestPracticeCard>
