...
const { setupAgenda } = require("./services/storyArchiver");
...
async function startServer() {
  try {
    ...
    try {
      await setupAgenda();
      console.log("Agenda job scheduling initialized successfully");
    } catch (agendaError) {
      console.error("Warning: Agenda setup failed:", agendaError);
