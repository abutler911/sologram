exports.buildWelcomeEmail = ({ name }) => `
  <div style="font-family: Arial, sans-serif; padding: 2rem; background: #f8f5f0; border-radius: 12px;">
    <h2 style="color: #e98973;">Welcome to SoloGram, ${name} 👋</h2>
    <p style="color: #444;">We're glad you're here. Start watching our thoughts, stories, and moments!</p>
