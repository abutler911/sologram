export const buildThoughtEmail = ({ content, thoughtId }) => {
  ...
  <div style="font-family: Arial, sans-serif; background: #f8f5f0; padding: 24px; max-width: 600px; margin: auto; border-radius: 10px;">
    ...
    <a href="https://www.thesologram.com/thoughts/${thoughtId}" style="display:inline-block; margin-top: 20px; background-color: #88b2cc; color: white; padding: 12px 20px; text-decoration: none; border-radius: 8px;">
      View Thought →
    </a>
  </div>`;
};
